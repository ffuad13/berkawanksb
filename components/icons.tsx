...
export const Logo = () => {
  return <Image src="/android-chrome-512x512.png" width={35} height={35} alt="Picture of the author" />;
};

export const LoginIcon: React.FC<IconSvgProps> = ({ size = 24, width, height, ...props }) => {
  return (
    <svg
